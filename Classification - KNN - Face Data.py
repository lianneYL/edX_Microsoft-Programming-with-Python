...
# TODO: Load up the face_data.mat in a dataset called "df". 
# Be sure to calculate the num_pixels value, and to rotate the images to being right-side-up instead of sideways. 
...
# TODO: Load up face_labels dataset. It only has a single column, and
...
# loaded it correctly
face_labelsDF = pd.read_csv('/Users/.../face_labels.csv', names = ['label'])
labels = face_labelsDF['label']
